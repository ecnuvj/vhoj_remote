...
public abstract class ComplexSubmitter implements Submitter {
     ...
     * until it appears.
     *
     * @return the time limit(milliseconds) Virtual com.vjudge.ecnuvj will try unless remote
     * run ID is retrieved
     */
    ...
    /**
     * @return the time interval(milliseconds) Virtual com.vjudge.ecnuvj will try unless
